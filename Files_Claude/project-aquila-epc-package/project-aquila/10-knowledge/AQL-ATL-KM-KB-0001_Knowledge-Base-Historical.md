> **CONFIDENTIAL — PROJECT AQUILA** · Atlas EPC Solutions — Knowledge Management
# KNOWLEDGE BASE — HISTORICAL PROJECT INTELLIGENCE

| Field | Value |
|---|---|
| **Document No.** | AQL-ATL-KM-KB-0001 |
| **Revision** | 1 |
| **Purpose** | Cross-project history to inform Aquila decisions and AI reasoning |

## 1. Historical NCRs (prior Atlas data-centre projects)
| Ref | Project | Issue | Resolution | Applicability to Aquila |
|---|---|---|---|---|
...
| H-NCR-198 | Project Draco (Pune) | Transformer oil-type mismatch vs spec | Replaced before dispatch | Cast-resin chosen for Aquila (dry-type) |
| H-NCR-176 | Project Cygnus | EPMS point mapping errors at SAT | Extended integration test | Mirrors Aquila P05/DEF-01 |

## 2. Historical RFIs
| Ref | Topic | Outcome | Aquila link |
|---|---|---|---|
...
| OrbitControls (OCA) | Cygnus | B- | **Integration schedule slippage** — same risk seen on Aquila (D-07) |
...
> *Footer:* AQL-ATL-KM-KB-0001 Rev 1 · Confidential
