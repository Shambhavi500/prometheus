...
import { runComplianceAudit } from '../api/actions/runComplianceAudit';
                        ...
                        <div style={{ borderTop: '1px solid var(--line-strong)', paddingTop: '16px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
                           ...
                           <div>
                             ...
                             {dev.downstreamRisks.map((risk, ridx) => (
                                <div key={ridx} style={{ background: 'var(--amber-dim)', border: '1px solid rgba(245, 158, 11, 0.2)', padding: '8px', borderRadius: 'var(--radius)', marginBottom: 8 }}>
                           ...
                           <div>
                             ...
                             <div style={{ background: 'var(--green-dim)', border: '1px solid rgba(16, 185, 129, 0.2)', padding: '12px', borderRadius: 'var(--radius)' }}>
                               <div style={{ fontSize: 'var(--fs-12)', color: 'var(--txt-hi)', marginBottom: 8 }}>{dev.recommendation.action}</div>
                               <div style={{ fontSize: 'var(--fs-11)', color: 'var(--green)', fontFamily: 'var(--font-mono)', background: 'var(--bg-0)', padding: '8px', border: '1px solid rgba(16, 185, 129, 0.1)', borderRadius: 'var(--radius)', whiteSpace: 'pre-wrap' }}>
