# Project Meghdoot — EPC DOCUMENTATION PACKAGE
...
Start here → **`00-project-information/MGD-ATL-PM-REG-0001_Project-Master-Data-Book.md`** (the
single source of truth for all equipment tags, vendors, POs and dates) and
**`MGD-ATL-PM-REG-0002_Master-Document-Register.md`** (index of every document).
...
## 3. Conventions (see `MGD-ATL-PM-STD-0001`)
- **Doc number:** `MGD-<ORIG>-<DISC>-<TYPE>-<NNNN>` + Rev + ISO 19650 status.
