> **CONFIDENTIAL — Project Meghdoot** · Helios Cloud Infrastructure · Prepared by Atlas EPC Solutions
> Uncontrolled when printed.
# DESIGN BASIS REPORT (ELECTRICAL & MECHANICAL)

| Field | Value |
|---|---|
| **Document No.** | MGD-ATL-EL-DBR-0002 |
| **Revision** | 0 (Issued for Construction) |
| **ISO 19650 Status** | A1 |
| **Discipline** | Electrical / Mechanical (multi-disc) |
| **Related equipment** | All SYS-EL / SYS-ME tags per MGD-ATL-PM-REG-0001 |
| **Related specs** | MGD-ATL-EL-SPC-0012 (UPS) and package specs |
| **Related calcs** | MGD-ATL-EL-CAL-0007 (UPS/load sizing) |

## 1. Purpose
Establish the engineering design basis for Project Meghdoot, a 48 MW hyperscale data centre
...
> *Footer:* MGD-ATL-EL-DBR-0002 Rev 0 · Confidential · IFC
