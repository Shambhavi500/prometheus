...
| Field | Value |
|---|---|
| **Document No.** | MGD-ATL-EL-SPC-0012 |
| **Revision** | C |
| **ISO 19650 Status** | A1 (approved for procurement) |
| **Discipline** | Electrical |
| **Related equipment** | UPS-01 … UPS-12, BAT-01 … BAT-12, STS-01 … STS-16 |
| **Related vendor / PO** | Meridian Critical Power (MCP) / MGD-ATL-PO-0012 |
| **Related calc** | MGD-ATL-EL-CAL-0007 |
| **Related DBR** | MGD-ATL-EL-DBR-0002 |
| **Related RFI** | MGD-ATL-EL-RFI-0052 |
...
| Type (Rev C, per VO-0011) | **Lithium-ion (LFP)**, 15-year design life — see Variation Order MGD-ATL-CO-VO-0011 |
...
> Variation Order **MGD-ATL-CO-VO-0011** (cost impact **MGD-ATL-CO-CIA-0011**). Material
> approval tracked under **MGD-ATL-PR-MAR-0044**.

## 4. Testing
Factory Acceptance Test (Cx **Level 1**) per ITP **MGD-ATL-QA-ITP-0009**, witnessed by Atlas
QA and Helios/CxA. Site Acceptance Test (Cx **Level 4**) per **MGD-NBC-CX-SAT-0012**.
...
manuals, spare parts list, training. Submitted via Vendor Data Sheet **MGD-MCP-EL-VDS-0012**.
...
efficiency shall be recorded in MGD-MCP-CX-FAT-0012 and any shortfall raised as an NCR.

> *Footer:* MGD-ATL-EL-SPC-0012 Rev C · Confidential
